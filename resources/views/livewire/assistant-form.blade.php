<div>
    <x-page-header :title="__('Add New Assistant')" :subtitle="__('Create a new user and assign the Assistant role and permissions.')" />
    ...
    <form wire:submit.prevent="save">
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div class="lg:col-span-1 space-y-6">
                <x-mary-card title="{{ __('Personal Details') }}" shadow separator>
                    ...
                    <x-mary-select label="{{ __('Gender') }}" :options="toSelectOptions()" single icon="o-users" />
            ...
            <div class="lg:col-span-1 space-y-6">
                <x-mary-card title="{!! __('Role & Permissions') !!}" shadow separator>
                    {{-- Updated role display to 'Assistant' --}}
                    <x-mary-input label="{{ __('Assigned Role') }}" value="Assistant" readonly icon="o-shield-check"
        ...
        <div class="mt-8 flex justify-end">
            <x-mary-button type="submit" label="{{ __('Create Assistant') }}" icon="o-user-plus"
